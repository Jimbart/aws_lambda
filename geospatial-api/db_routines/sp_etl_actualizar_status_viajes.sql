...
DROP PROCEDURE IF EXISTS sp_etl_actualizar_status_viajes;

DELIMITER //

CREATE PROCEDURE `sp_etl_actualizar_status_viajes`(
	_idCedi INT,
	_json_viajes JSON
)
BEGIN
	...
	WHILE _viaje < _viajes DO
        ...
        VALUES(
            ...
            ,JSON_EXTRACT(_json_viajes, CONCAT('$[',_viaje,'].status'))
        );
	    SET _viaje = _viaje + 1;
